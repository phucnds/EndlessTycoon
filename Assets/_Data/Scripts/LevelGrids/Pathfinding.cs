...
namespace EndlessTycoon.LevelGrids
{
    public class Pathfinding: Singleton<Pathfinding>
    {
        ...
        private List<PathNode> GetNeighbourList(PathNode currentNode)
        {
            ...
            UP = GridPosition.y + 1 < gridSystem.GetHeight();
            DOWN = GridPosition.y - 1 > 0;

            if (LEFT) neighbourList.Add(GetNode(GridPosition.x - 1, GridPosition.y + 0));
            if (RIGHT) neighbourList.Add(GetNode(GridPosition.x + 1, GridPosition.y + 0));
            if (UP) neighbourList.Add(GetNode(GridPosition.x + 0, GridPosition.y + 1));
            if (DOWN) neighbourList.Add(GetNode(GridPosition.x + 0, GridPosition.y - 1));

            if (LEFT && DOWN) neighbourList.Add(GetNode(GridPosition.x - 1, GridPosition.y - 1));
            if (LEFT && UP) neighbourList.Add(GetNode(GridPosition.x - 1, GridPosition.y + 1));
            if (RIGHT && DOWN) neighbourList.Add(GetNode(GridPosition.x + 1, GridPosition.y - 1));
            if (RIGHT && UP) neighbourList.Add(GetNode(GridPosition.x + 1, GridPosition.y + 1));
